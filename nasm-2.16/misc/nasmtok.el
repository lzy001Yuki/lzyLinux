...
;;; assembler, automatically extracted from NASM 2.16.
;;;
...
(defconst nasm-decorator
  '("1to16" "1to2" "1to32" "1to4" "1to8" "rd-sae" "rn-sae" "ru-sae" "rz-sae"
    "sae" "z")
  "NASM 2.16 decorator tokens for `nasm-mode'.")
...
(defconst nasm-directive
  ...
  "NASM 2.16 directive tokens for `nasm-mode'.")
...
(defconst nasm-function
  ...
  "NASM 2.16 function tokens for `nasm-mode'.")
...
(defconst nasm-instruction
  ...
  "NASM 2.16 instruction tokens for `nasm-mode'.")

(defconst nasm-operator
  '("!=" "%%" "&&" "//" "<<" "<<<" "<=" "<=>" "<>" "==" ">=" ">>" ">>>" "?"
    "^^" "||")
  "NASM 2.16 operator tokens for `nasm-mode'.")
...
(defconst nasm-pp-directive
  ...
  "NASM 2.16 pp-directive tokens for `nasm-mode'.")
...
(defconst nasm-prefix
  ...
  "NASM 2.16 prefix tokens for `nasm-mode'.")
